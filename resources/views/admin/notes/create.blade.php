    ...
    <form method="POST" action="{{ route('admin.notes.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div class="space-y-2">
            ...
            <textarea name="content" id="editor"
                class="w-full rounded-3xl border border-slate-800 bg-slate-950/70 px-5 py-3 text-base text-slate-100 focus:border-amber-300 focus:outline-none">{{ old('content') }}</textarea>
        </div>
